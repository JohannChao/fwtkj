 ...
 *
 * @ClassName: ZyhFactoryDemo
 * @Description:
 * @Author: Johann
 * @Version: 1.0
 **/
public class ZyhFactoryDemo {
    public static void main(String[] args) {
        CalculationContext context = new CalculationContext("8z_m100f10");
        System.out.println(context.getResult(100d,12d));

        context = new CalculationContext("m100f10_8z");
        System.out.println(context.getResult(100d,12d));

        context = new CalculationContext("zc");
        System.out.println(context.getResult(100d,12d));

        context = new CalculationContext("7z");
        System.out.println(context.getResult(100d,12d));

        context = new CalculationContext("m100f10");
        System.out.println(context.getResult(100d,12d));
    }
}
