...
public class ZyhAbstractFactoryDemo {
    public static void main(String[] args) {
        ...
        String databaseName = properties.getProperty("abstractFactory.databaseName");
        // 使用反射获取所需工厂
    ...
    public static IDatabaseFactory getDatabaseFactory(String database){
        ...
        StringBuilder className = new StringBuilder("com.johann.designPattern.designPatterns23.B_abstractFactory.");
