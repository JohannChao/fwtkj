...
class SolutionJianzhi03 {
    ...
    public int findRepeatNumber3(int[] nums) {
        for (int i = 0; i < nums.length; i++) {
             ...
             * 例如 :
             *     int[] nums = {1,3,2,2,4};
             *     nums[0] = 1，不满足 nums[0] == 0，交换 索引0和索引1的元素
             *     交换后的数组为 {3,1,2,2,4};
             *     nums[0] = 3，继续交换 索引0和索引3的元素
             *     交换后的数组为 {2,1,2,3,4};
             *      nums[0] = 2，此时nums[2] 也是2，出现重复元素，终止循环，返回重复元素
             */
            while (nums[i] != i) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new SolutionJianzhi03().findRepeatNumber3(nums));
    }
}
